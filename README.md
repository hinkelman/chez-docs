...
`chez-docs` uses a call to `system` to open documentation in your default browser. The code used to scrape the Chez Scheme User's Guide for use in `chez-docs` is in a [separate repository](https://github.com/hinkelman/chez-docs-scrape). 
